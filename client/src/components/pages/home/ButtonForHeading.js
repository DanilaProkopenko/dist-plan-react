...
const ButtonForHeading = () => {
    return (
        <div className="button__flex__container">
            <div className="button-for-about">
                ...
                <div className="text">
                    <Link className="menu__link" to="#">Подробнее</Link>
                    {/* <a data-goto=".about" href="" className="menu__link">Подробнее</a> */}
                </div>
            </div>
        </div>
    );
...
export default ButtonForHeading